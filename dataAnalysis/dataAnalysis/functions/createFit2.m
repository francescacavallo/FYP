function [pd1,pd2] = createFit2(arg_1,arg_2)
...
% This function was automatically generated on 14-Jun-2018 10:46:24

% Output fitted probablility distributions: PD1,PD2

% Data from dataset "leptinIntervention(:,1) data":
%    Y = arg_1 (originally leptinIntervention(:,1))

% Data from dataset "leptinIntervention(:,5) data":
%    Y = arg_2 (originally leptinIntervention(:,5))
...
% --- Plot data originally in dataset "leptinIntervention(:,5) data"
...
ylabel('Density')
LegHandles(end+1) = hLine;
LegText{end+1} = 'leptinIntervention(:,5) data';
...
%     pd1 = ProbDistUnivParam('normal',[ 0.3653570091973, 0.1893231353856])
...
% Fit this distribution to get parameter values
% To use parameter estimates from the original fit:
%     pd2 = ProbDistUnivParam('normal',[ 0.7092951357448, 0.4544484944694])
