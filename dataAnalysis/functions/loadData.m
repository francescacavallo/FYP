...
tmp = readtable("../spreadsheets/FFQsorted.xlsx",'Sheet','FFQ7');
FFQ{7} = table2cell(tmp);
tmp = readtable("../spreadsheets/FFQsorted.xlsx",'Sheet','FFQ8');
FFQ{8} = table2cell(tmp);
tmp = readtable("../spreadsheets/FFQsorted.xlsx",'Sheet','FFQ9');
FFQ{9} = table2cell(tmp);
